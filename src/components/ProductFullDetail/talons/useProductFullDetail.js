...
export const useProductFullDetail = props => {
    ...
    const { loading: loadingGM, error: errorGm, data: dataGm } = useQuery(GET_GTM_VIEW_ITEM, {
        variables: {
            sku: product.sku,
        },
        skip: !product.sku // Skip query if increment_id is empty or falsy
    });
