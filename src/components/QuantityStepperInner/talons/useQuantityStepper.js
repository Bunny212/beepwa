...
export const useQuantityStepper = props => {
    const { initialValue, min, onChange, isItemInCart, itemQty } = props;
     ...
     */
    useEffect(() => {
        quantityFieldApi.setValue(isItemInCart ? itemQty : initialValue);
    }, [initialValue, quantityFieldApi, isItemInCart, itemQty]);
