...
import { DEFAULT_LINKS, ABOUT_BEE_FOOTER } from './footerData';
    ...
    return (
        <div>
            {isDesktop ? (
                <footer data-cy="Footer-root" className={classes.root}>
                    <div className={classes.links}>
                        ...
                        <div className={classes.callout}>
                            ...
                            >
                                <FormattedMessage
                                    id={'footer.aboutBeeFooter'}
                                    defaultMessage={ABOUT_BEE_FOOTER}
                                />
                            </p>
                ...
                <Box className={classes.footerSpace} sx={{ height: '56px' }} />
            )}
        </div>
    );
};
