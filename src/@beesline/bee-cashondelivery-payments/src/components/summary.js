...
/**
 * The Summary component of the CashOnDelivery / Money Order payment method extension.
 */
const Summary = props => {
    const { onEdit } = props;
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.cashondelivery_details_container}>
...
Summary.propTypes = {
    classes: shape({
        root: string,
        cashondelivery_details_container: string,
        edit_button: string,
        edit_icon: string,
        edit_text: string,
